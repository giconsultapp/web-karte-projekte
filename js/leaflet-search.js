    ...
    (a.Control.Search = a.Control.extend({
          ...
          this.options.marker &&
            ...
            this.options.marker instanceof a.CircleMarker
              ...
              : c(this.options.marker) &&
                (this._markerSearch = new a.Control.Search.Marker([0, 0], this.options.marker)),
      ...
      _recordsFromJsonp: function (b, c) {
        ...
        var d = a.DomUtil.create(
          ...
          e = a.Util.template(
            this._getUrl(b) + '&' + this.options.jsonpParam + '=L.Control.Search.callJsonp',
            { s: b }
          );
        return (
          ...
          if (((this._input.value = b), this._handleAutoresize(), this._input.createTextRange)) {
            ...
            this._input.setSelectionRange
              ...
              : this._input.selectionStart &&
                ((this._input.selectionStart = a), (this._input.selectionEnd = c));
      },
      ...
      _handleKeypress: function (a) {
        switch (a.keyCode) {
          case 27:
            ...
            break;
          case 13:
            (1 == this._countertips || (this.options.firstTipSubmit && this._countertips > 0)) &&
      ...
      _handleAutoresize: function () {
        this._input.style.maxWidth != this._map._container.offsetWidth &&
          (this._input.style.maxWidth = a.DomUtil.getStyle(this._map._container, 'width')),
        ...
        if (1 == b && this._tooltip.currentSelection >= c.length - 1)
          ...
          this._tooltip.scrollTop + this._tooltip.clientHeight
            ? (this._tooltip.scrollTop =
                d - this._tooltip.clientHeight + c[this._tooltip.currentSelection].clientHeight)
